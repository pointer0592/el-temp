...
const formRules: FormRules = reactive({
  username: [{ required: true, trigger: "blur", message: "Username" }],
  password: [{ required: true, trigger: "blur", message: "Password" }]
})
const handleCreate = () => {
...
const handleDelete = (row: GetTableData) => {
  ElMessageBox.confirm(`Deleting userr：${row.username}，Confirm？`, "Hint", {
...
<template>
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="username" label="用户名">
          <el-input v-model="searchData.username" placeholder="Username" />
        </el-form-item>
        <el-form-item prop="phone" label="手机号">
          <el-input v-model="searchData.phone" placeholder="Phone" />
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog
      ...
      :title="currentUpdateId === undefined ? 'New Users' : 'Edit Users'"
      @close="resetForm"
      width="30%"
    >
